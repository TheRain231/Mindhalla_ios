...
struct SaveBottomsheetView: View {
    ...
    @Bindable  private var viewModel = SaveBottomsheetViewModel()
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationDestination(for: String.self) { _ in
                NewSelectionBottomsheetView(viewModel: viewModel)
            }
        }
    }
    ...
    private var searchField: some View {
        HStack {
            Image(systemName: "magnifyingglass")
                .foregroundStyle(.secondary)
            TextField("search_selection", text: $viewModel.searchText)
    ...
    private var newSelectionLink: some View {
        NavigationLink(value: "new_selection") {
            Label("SaveBottomsheetScreen.NewSelection", systemImage: "plus")
                .padding(6)
